...
export function StationTooltip({ station, x, y }: StationTooltipProps) {
  return (
    <div
      className="pointer-events-none absolute z-20 max-w-64 -translate-x-1/2 -translate-y-full rounded-lg border border-white/10 bg-slate-900/95 px-3 py-2 text-sm text-slate-100 shadow-xl backdrop-blur"
